...
import { unfavoriteArticle } from './UnfavoriteArticle.controller';
...
router.post('/:slug/favorite', checkSession(), favoriteArticle);
router.delete('/:slug/favorite', checkSession(), unfavoriteArticle);
